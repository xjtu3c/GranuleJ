...
public class AssignLShiftExpr extends AssignShiftExpr implements Cloneable {
   ...
   * @ast method 
   * @aspect CreateBCode
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CreateBCode.jrag:607
   */
  public void createBCode(CodeGeneration gen) { emitShiftExpr(gen); }
  /**
   * @ast method 
   * @aspect CreateBCode
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CreateBCode.jrag:695
   */
   ...
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\PrettyPrint.jadd:361
   */
  @SuppressWarnings({"unchecked", "cast"})
