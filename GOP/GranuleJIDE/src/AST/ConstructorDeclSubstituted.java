...
public class ConstructorDeclSubstituted extends ConstructorDecl implements Cloneable {
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.5Backend\GenericsCodegen.jrag:45
   */
   ...
   * @ast method 
   * @aspect GenericsCodegen
   * @declaredat D:\zhh\JastAddJ\Java1.5Backend\GenericsCodegen.jrag:49
   */
   ...
   * @ast method 
   * @aspect GenericsCodegen
   * @declaredat D:\zhh\JastAddJ\Java1.5Backend\GenericsCodegen.jrag:194
   */
  ...
  /**   * @apilvl internal   */  protected ConstructorDecl tokenConstructorDecl_Original;
  /**
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Generics.jrag:1281
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) sourceConstructorDecl_computed = true;
   ...
   * @attribute syn
   * @aspect GenericsCodegen
   * @declaredat D:\zhh\JastAddJ\Java1.5Backend\GenericsCodegen.jrag:198
   */
  @SuppressWarnings({"unchecked", "cast"})
