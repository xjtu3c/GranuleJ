...
public class AssignRShiftExpr extends AssignShiftExpr implements Cloneable {
   ...
   * @ast method 
   * @aspect CreateBCode
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CreateBCode.jrag:608
   */
  public void createBCode(CodeGeneration gen) { emitShiftExpr(gen); }
  /**
   * @ast method 
   * @aspect CreateBCode
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CreateBCode.jrag:696
   */
   ...
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\PrettyPrint.jadd:362
   */
  @SuppressWarnings({"unchecked", "cast"})
