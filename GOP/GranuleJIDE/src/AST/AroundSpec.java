 ...
 */
public class AroundSpec extends AuxiliarySpec implements Cloneable {
  /**
   * @apilvl low-level
   */
  ...
  public AroundSpec clone() throws CloneNotSupportedException {
   ...
   */
  public AroundSpec(List<ParameterDeclaration> p0) {
    setChild(p0, 0);
  }
  /**
   * @apilvl low-level
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\AuxiliaryMethod.jrag:6
   */
  @SuppressWarnings({"unchecked", "cast"})
  public String kind() {
