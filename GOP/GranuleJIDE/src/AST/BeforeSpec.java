 ...
 */
public class BeforeSpec extends AuxiliarySpec implements Cloneable {
  /**
   * @apilvl low-level
   */
  ...
  public BeforeSpec clone() throws CloneNotSupportedException {
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\AuxiliaryMethod.jrag:4
   */
  @SuppressWarnings({"unchecked", "cast"})
  public String kind() {
