...
public class EnumDecl extends ClassDecl implements Cloneable {
   ...
   * @ast method 
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:46
   */
   ...
   * @ast method 
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:81
   */
   ...
   * @ast method 
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:82
   */
   ...
   * @ast method 
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:309
   */
   ...
   * @ast method 
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:453
   */
   ...
   * @ast method 
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:536
   */
   ...
   * @aspect Annotations
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Annotations.jrag:132
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  * @attribute syn
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:17
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  * @attribute syn
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:39
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) isStatic_computed = true;
  ...
  * @attribute syn nta
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:60
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) getSuperClassAccessOpt_computed = true;
  ...
  * @attribute syn
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:283
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:294
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) enumConstants_computed = true;
  ...
  * @attribute syn
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:431
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect EnumsCodegen
   * @declaredat D:\zhh\JastAddJ\Java1.5Backend\EnumsCodegen.jrag:13
   */
  @SuppressWarnings({"unchecked", "cast"})
  public int flags() {
    if(flags_computed) {
...
if(isFinal && num == state().boundariesCrossed) flags_computed = true;
   ...
   * @attribute inh
   * @aspect Enums
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:421
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:33
   * @apilvl internal
   */
  ...
  /**
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:40
   * @apilvl internal
   */
  ...
  /**
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:292
   * @apilvl internal
   */
  ...
  public ASTNode rewriteTo() {
    // Declared in D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag at line 88
    if(!done()) {
      state().duringEnums++;
  ...
  /**
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Enums.jrag:88
   * @apilvl internal
