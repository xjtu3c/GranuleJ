...
public class NEExpr extends EqualityExpr implements Cloneable {
   ...
   * @ast method 
   * @aspect CreateBCode
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CreateBCode.jrag:1739
   */
  public void compareBranch(CodeGeneration gen, int label, TypeDecl typeDecl) { typeDecl.branchNE(gen, label); }
  /**
   * @ast method 
   * @aspect CreateBCode
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CreateBCode.jrag:1749
   */
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\ConstantExpression.jrag:532
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\PrettyPrint.jadd:546
   */
  @SuppressWarnings({"unchecked", "cast"})
