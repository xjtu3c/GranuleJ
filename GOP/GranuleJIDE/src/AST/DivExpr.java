...
public class DivExpr extends MultiplicativeExpr implements Cloneable {
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CodeGeneration.jrag:1139
   */
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\ConstantExpression.jrag:118
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect ConstantExpression
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\ConstantExpression.jrag:497
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\PrettyPrint.jadd:529
   */
  @SuppressWarnings({"unchecked", "cast"})
