...
public class SingleTypeImportDecl extends ImportDecl implements Cloneable {
   ...
   * @ast method 
   * @aspect NameCheck
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\NameCheck.jrag:20
   */
   ...
   * @ast method 
   * @aspect PrettyPrint
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\PrettyPrint.jadd:50
   */
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\LookupType.jrag:274
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) importedTypes_String_values.put(_parameters, importedTypes_String_value);
   ...
   * @attribute inh
   * @aspect NameCheck
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\NameCheck.jrag:26
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\SyntacticClassification.jrag:72
   * @apilvl internal
   */
