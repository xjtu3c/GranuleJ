...
public class RShiftExpr extends ShiftExpr implements Cloneable {
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CodeGeneration.jrag:1143
   */
  void emitOperation(CodeGeneration gen)     { type().shr(gen); }
  /**
   * @ast method 
   * @aspect CreateBCode
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CreateBCode.jrag:1479
   */
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\ConstantExpression.jrag:125
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\PrettyPrint.jadd:534
   */
  @SuppressWarnings({"unchecked", "cast"})
