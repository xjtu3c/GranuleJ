...
public class DoubleLiteral extends Literal implements Cloneable {
   ...
   * @ast method 
   * @aspect PrettyPrint
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\PrettyPrint.jadd:392
   */
   ...
   * @ast method 
   * @aspect TypeCheck
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\TypeCheck.jrag:587
   */
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CodeGeneration.jrag:506
   */
   ...
   * @ast method 
   * @aspect CodeGeneration
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CodeGeneration.jrag:571
   */
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\ConstantExpression.jrag:147
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) isZero_computed = true;
   ...
   * @attribute syn
   * @aspect ConstantExpression
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\ConstantExpression.jrag:292
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) constant_computed = true;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\TypeAnalysis.jrag:402
   */
  @SuppressWarnings({"unchecked", "cast"})
