...
public class URShiftExpr extends ShiftExpr implements Cloneable {
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CodeGeneration.jrag:1144
   */
  void emitOperation(CodeGeneration gen)    { type().ushr(gen); }
  /**
   * @ast method 
   * @aspect CreateBCode
   * @declaredat D:\zhh\JastAddJ\Java1.4Backend\CreateBCode.jrag:1480
   */
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\ConstantExpression.jrag:126
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat D:\zhh\JastAddJ\Java1.4Frontend\PrettyPrint.jadd:535
   */
  @SuppressWarnings({"unchecked", "cast"})
