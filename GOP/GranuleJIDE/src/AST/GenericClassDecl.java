...
public class GenericClassDecl extends ClassDecl implements Cloneable, GenericTypeDecl {
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Generics.jrag:396
   */
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Generics.jrag:1087
   */
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\GenericsPrettyPrint.jrag:61
   */
   ...
   * @ast method 
   * @aspect GenericsPrettyPrint
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\GenericsPrettyPrint.jrag:73
   */
   ...
   * @attribute syn
   * @aspect Generics
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Generics.jrag:154
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) rawType_computed = true;
   ...
   * @attribute syn nta
   * @aspect LookupParTypeDecl
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Generics.jrag:592
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getParTypeDeclList_computed = true;
   ...
   * @attribute syn
   * @aspect LookupParTypeDecl
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Generics.jrag:596
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) lookupParTypeDecl_ParTypeAccess_values.put(_parameters, lookupParTypeDecl_ParTypeAccess_value);
   ...
   * @attribute syn
   * @aspect LookupParTypeDecl
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Generics.jrag:633
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) lookupParTypeDecl_ArrayList_values.put(_parameters, lookupParTypeDecl_ArrayList_value);
   ...
   * @attribute syn
   * @aspect LookupParTypeDecl
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Generics.jrag:922
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\GenericsSubtype.jrag:13
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect GenericsSubtype
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\GenericsSubtype.jrag:273
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect GenericsSubtype
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\GenericsSubtype.jrag:275
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect GenericsSubtype
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\GenericsSubtype.jrag:394
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) instanceOf_TypeDecl_values.put(_parameters, Boolean.valueOf(instanceOf_TypeDecl_value));
   ...
   * @declaredat D:\zhh\JastAddJ\Java1.5Backend\GenericsCodegen.jrag:204
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) constantPoolName_computed = true;
   ...
   * @attribute syn
   * @aspect GenericsCodegen
   * @declaredat D:\zhh\JastAddJ\Java1.5Backend\GenericsCodegen.jrag:369
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) needsSignatureAttribute_computed = true;
   ...
   * @attribute syn
   * @aspect GenericsCodegen
   * @declaredat D:\zhh\JastAddJ\Java1.5Backend\GenericsCodegen.jrag:433
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) classSignature_computed = true;
   ...
   * @attribute inh
   * @aspect GenericsTypeCheck
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Generics.jrag:406
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Generics.jrag:452
   * @apilvl internal
   */
  ...
  /**
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\Generics.jrag:453
   * @apilvl internal
   */
   ...
   int childIndex = caller.getIndexOfChild(child);
{
  ...
  /**
   * @declaredat D:\zhh\JastAddJ\Java1.5Frontend\GenericsParTypeDecl.jrag:48
   * @apilvl internal
   */
