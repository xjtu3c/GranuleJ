...
public interface ConstString {
	/*public static final String[] menus = new String[] { "文件", "编辑", "工程", "运行", "窗口", "帮助" };
	public static final String[] fileItems = new String[] { "新建", "全部保存", "切换项目", "关闭项目"};
	public static final String[] fileSubItems = new String[] { "工程", "包", "类", "接口", "粒",
			"影子类" };
	public static final String[] editItems = new String[] { "剪切", "复制", "粘贴", "查找/替换" };
	public static final String[] projectItems = new String[] { "编译", "清理", "网络环境","网络仿真" };
	public static final String[] runItems = new String[] { "运行", "调试","运行环境"};
	...
	public static final String[] fileSubItems = new String[] { "Project", "Package", "Class", "Interface", "Granule",
			"Shadow Class" };
	public static final String[] editItems = new String[] {"Undo", "Redo", "Cut", "Copy", "Paste","Delete","Find/Replace","Change Corlor" };
	public static final String[] projectItems = new String[] { "Build", "Clean", "Network Environment","Network Simulation" };
