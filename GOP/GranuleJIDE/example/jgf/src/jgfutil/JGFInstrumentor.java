...
public class JGFInstrumentor{
  ...
  public static synchronized void printHeader(int section, int size) {
    ...
    String header, x_base; 
 
    header = "";
    x_base = "Java Grande Forum Benchmark Suite - Version 2.0 - Section "; 
    ...
    case 2:
      switch (size) {
      case 0:
	header = x_base + "2 - Size A";
	break;
      case 1:
	header = x_base + "2 - Size B";
	break;
      case 2:
	header = x_base + "2 - Size C";
	break;
      }
      break; 
    case 3:    
      switch (size) {
      case 0:
	header = x_base + "3 - Size A";
	break;
      case 1:
	header = x_base + "3 - Size B";
	break;
      }
      break; 
    }
