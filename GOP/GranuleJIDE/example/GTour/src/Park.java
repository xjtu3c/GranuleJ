...
public class Park extends Site{
	private String introduction="Welcome to "+getName()+" ! "+"Welcome to "+getName()+" ! "+
	...
	public void createUI(){
		...
		ParkActionListener park_action_listener=new ParkActionListener(getShowPanel(),getServerInfo(),this);
		for(String menu:button_menu){
			JButton button=new JButton(menu);
			button.addActionListener(park_action_listener);
